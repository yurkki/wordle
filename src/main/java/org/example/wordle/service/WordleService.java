...
public class WordleService {
    ...
    public WordleService(DailyWordService dailyWordService) {
        ...
        "АКТЁР", "АМЁБА", "АФЁРА", "АКЦИЯ", "АЛЛЕЯ", "АРМИЯ", "АРМЯК",
        "БРАВО", "БРАГА", "БРАМА", "БРАНЬ", "БРАСС",
        "БРЕЗГ", "БРЕМЯ", "БРЕНД",
        "БРЕШЬ", "БРИДЖ", "ВАЛЁК", "ВЗЛЁТ", "ВЗМЁТ", "ВИТЬЁ",
        "ВОРЬЁ", "ВЫТЬЁ", "ВАДЬЯ", "ВАРЯГ", "ВАФЛЯ","ГАЛЬЁ", "ГАРЬЁ", "ГРЁЗА", "ГЛЯСЕ", "ГЛЯЧЕ","ГОЛЯК",
        "ДЕЛЁЖ", "ДЕНЁК", "ДОМЁК",  "ДВОЯК", "ЗАЛЁТ", "ЗАМЁТ", "ЗАВЕЯ",  "ЗАРЯД", "ЗАТЕЯ", "ЗАТЯГ", 
        "КЛЁШИ", "КОВЁР", "КОЗЁЛ", "КОНЁК", "КОПЬЁ",  "КАПЛЯ", "КАПСЯ", 
        "ЛАРЁК", "ЛИКЁР", "ЛИНЁК", "ЛИТЬЁ","ЛАДЬЯ", "ЛАЗНЯ","ЛЕПНЯ", "ЛЕШНЯ", "ЛИЛИЯ",
        "БИЛЕТ", "КНИГА", "ВЕСНА", "ОГОНЬ", "ДРОВА", "ПЕСОК", "СТЕПЬ", "ГОРОД", "ПТИЦА", "ЗВЕЗДА",
        "РУЧЕЙ","ЛЫЖНЯ",  "ЧАЙКА", "САХАР", "СЕДЛО", "ПОЕЗД", "ЛАМПА",
